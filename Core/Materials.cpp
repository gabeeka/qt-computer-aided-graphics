...
{
    _front_ambient[3] = _front_diffuse[3] = _front_specular[3] = _front_emissive[3] = alpha;
    _back_ambient[3] = _back_diffuse[3] = _back_specular[3] = _back_emissive[3] = alpha;
}
...
{
    return _front_diffuse[3] < 1 && _back_diffuse[3] < 1;
}
